...
from models.classes.ToyTextGenerator import ToyTextGenerator
from utils.models import collate_for_bertgen, get_latest_model
...
def main(hparams):
    ...
    if hparams.TRAIN == "True":
        ...
        train_loader = DataLoader(dataset_train, batch_size=hparams.b_size, collate_fn=collate_for_bertgen,
                                  num_workers=hparams.num_workers, shuffle=True, drop_last=True, pin_memory=True)
        valid_loader = DataLoader(dataset_valid, batch_size=hparams.b_size, collate_fn=collate_for_bertgen,
    ...
    model = ToyTextGenerator(**arguments)
    print("Model Loaded.")
    if hparams.TRAIN == "True":
    ...
    if hparams.TEST == "True":
        ...
        test_loader = DataLoader(dataset_test, batch_size=hparams.b_size, collate_fn=collate_for_bertgen,
