...
from models.classes.TextClassifier import TextClassifier
from utils.models import collate_for_att_classif_exp, collate_for_att_classif_ind, get_latest_model
...
def main(hparams):
    ...
    if hparams.att_type == "exp":
        collate_fn = collate_for_att_classif_exp
    elif hparams.att_type == "ind":
        collate_fn = collate_for_att_classif_ind
    else:
        raise Exception("Wrong att type specified! Can be \"ind\" or \"exp\" got: " + hparams.att_type)
    ...
    model = TextClassifier(**arguments)
    print("Model Loaded.")
    if hparams.TRAIN == "True":
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="text_classifier")
