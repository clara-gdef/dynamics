...
from models.classes.RewriterDeltaBertIndSub import RewriterDeltaBertIndSub
...
if __name__ == "__main__":
    ...
    parser.add_argument("--denoising_only", type=str, default="True")
    # model attributes
    ...
    parser.add_argument("--model_type", type=str, default="deltaBertIndSubDAE")
