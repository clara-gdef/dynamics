...
class LSTMAttentionDecoderToy(pl.LightningModule):
    def __init__(self, input_size, hidden_size, emb_dim, voc_size, hp):
        super().__init__()
        self.hp = hp
        self.hs = hidden_size
        self.num_layer = 2
    ...
    def forward(self, embedded_conditionning, emb_attributes):
        output_lstm, hidden = self.LSTM(embedded_conditionning)
